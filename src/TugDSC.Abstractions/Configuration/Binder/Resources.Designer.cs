...
namespace TugDSC.Configuration.Binder
{
    ...
    internal static class Resources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("TugDSC.Configuration.Binder.Resources", typeof(Resources).GetTypeInfo().Assembly);

        /// <summary>
        /// Cannot create instance of type '{0}' because it is not assignable to target type of '{1}'.
        /// </summary>
        internal static string Error_TypeNotAssignableToTargetType
        {
            get => GetString("Error_TypeNotAssignableToTargetType");
        }

        /// <summary>
        /// Cannot create instance of type '{0}' because it is not assignable to target type of '{1}'.
        /// </summary>
        internal static string FormatError_TypeNotAssignableToTargetType(object p0, object p1)
            => string.Format(CultureInfo.CurrentCulture, GetString("Error_TypeNotAssignableToTargetType"), p0, p1);
