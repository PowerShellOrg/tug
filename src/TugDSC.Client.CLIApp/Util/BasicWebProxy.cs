...
namespace TugDSC.Client.Util
{
    ...
    //
    //
    // TODO: Is this class needed anymore?  In ASP.NET Core 1.x, a default implementation
    //       of IWebProxy did not existing, but 2.x ports over a default impl from the BCL
    //
